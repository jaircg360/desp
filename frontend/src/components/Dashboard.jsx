...
export default function Dashboard({ onModelsUpdate }) {
  ...
  const captureSample = async () => {
    ...
    try {
      ...
      setSamplesCount(res.data.n_samples);
  ...
  // Efecto de tecleo para el título
  useEffect(() => {
  ...
  return (
    <div className="dark-dashboard">
      ...
      <header className="dashboard-header">
        <h1 className="typing-title">Sistema de Reconocimiento de Señas</h1>
          ...
          <div className="col-lg-8">
            <div className="camera-container">
              <div className="camera-frame">
                ...
                <div className={`hand-status ${isDetectingHand ? 'hand-detected' : 'hand-not-detected'}`}>
                  <i className={`fas ${isDetectingHand ? 'fa-hand-paper' : 'fa-hand-point-up'}`}></i>
                  {isDetectingHand ? 'Mano detectada' : 'Esperando mano...'}
                </div>
              </div>
